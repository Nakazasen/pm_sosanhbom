' Stream: VBA/md_tinhnangkhac
' File: md_tinhnangkhac.bas

Attribute VB_Name = "md_tinhnangkhac"
Sub taifiletonghopmaT()
Call Focus(True)
    ...
    duongdan = wbth.Path
    duongdan = duongdan & "\"
    tenform_thT = Dir(ws_link.Range("A2").Value & "*maT*")
    ...
    namerutgon = namerutgon & Format(Date, "dd.mm.yyyy") & "_maT.xlsm"
...
'khai bao.
    ...
    For Each ObjTarget In ObjSubFolder
            ...
            If mamay = 1 Then
               ...
               Kill (ObjTarget & "\" & Dir(duongdan & "*maT*"))
    ...
    Set fc = f.files
    For Each f1 In fc
         If f1.Name = Dir(folder_taifile & "*maT*") Then
            tenform_thT = f1.Name
